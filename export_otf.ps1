...
bin/otf_exporter.exe asset/raw/cinzel.otf asset/menu_large_font.asset 120
bin/otf_exporter.exe asset/raw/cinzel.otf asset/menu_medium_font.asset 96
bin/otf_exporter.exe asset/raw/cinzel.otf asset/menu_small_font.asset 72
